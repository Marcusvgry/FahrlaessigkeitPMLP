...
export const instructionTexts: InstructionTexts = {
  instruction: `
    <div class="instructions">
      ...
      <p>Vielen Dank für Ihr Interesse an der Online-Studie zur Beurteilung der Fahrlässigkeit in Alltagssituationen.</p>
      <p><strong>ACHTUNG:</strong> Wenn sie bereits an der Studie: Laienurteile über Fahrlässigkeit in Alltagssituationen (Lay Judgements of Negligence in Everyday Situations) teilgenommen haben, können sie <strong>nicht</strong> an dieser Studie teilnehmen!</p>
      <p>Bevor Sie sich dazu entscheiden, teilzunehmen, werden Sie über den Ablauf und das Ziel der Untersuchung informiert. Lesen Sie dazu bitte die nachfolgenden Informationen sorgfältig durch. </p>
    </div>
  `,
  ...
  informedConsentOne: `
    <div class="instructions">
      ...
      Zu Beginn werden Sie gebeten, einige allgemeine Angaben zu Ihrer Person zu machen. Anschließend erhalten Sie eine kurze Einführung in den Ablauf der Studie. Im Folgenden wird ihnen ein Fragebogen sowie ein Informationsvideo über das Gedächtnis vorgelegt. Danach erhalten Sie eine Definition des Begriffs Fahrlässigkeit. <br>

      Im letzten Teil der Studie werden Ihnen mehrere kurze Fallvignetten aus unterschiedlichen Alltagssituationen präsentiert. Nach jeder Fallvignette werden Sie gebeten, Einschätzungen zur Fahrlässigkeit der handelnden Person abzugeben.<br>

      Die Teilnahme erfolgt vollständig online und kann über PC/Laptop, Tablet oder Smartphone durchgeführt werden. </p>
...
Personen mit juristischen Vorkenntnissen (z.B. Studium oder berufliche Tätigkeit im juristischen Bereich) sind von der Teilnahme ausgeschlossen, da die Studie laienhafte Bewertungen untersucht.
      ...
      Die Teilnahme an dieser Studie ist freiwillig. Sie können Ihre Teilnahme jederzeit und ohne Angabe von Gründen abbrechen, ohne dass Ihnen dadurch Nachteile entstehen. <br>
...
Da die Datenerhebung anonym erfolgt, ist ein nachträglicher Widerruf der Nutzung bereits erhobener Daten nach Abschluss der Teilnahme nicht mehr möglich. Bei Fragen zur Studie können Sie sich jederzeit an die Studienleitung wenden.
  ...
  informedConsentTwo: `
    <div class="instructions">
      ...
      Als teilnehmende Person können Sie jederzeit Fragen über alle Angelegenheiten im Zusammenhang mit der Studie stellen. Bei Rückfragen stehe ich Ihnen gerne per E-Mail zur Verfügung. <br>
  ...
  videoIntroC: `
    <div class="instructions">
      <p>Jetzt wird Ihnen ein kurzes Informationsvideo bezüglich Routinen vorgespielt. Bitte schauen sie sich dieses aufmerksam bis zum Ende an. Danach werden Ihnen ein paar Verständnisfragen zu dem Inhalt des Videos gestellt.</p>
    </div>
  `,
  ...
  negligenceDefinition: `
    <div class="instructions">
      ...
      Fahrlässigkeit bezeichnet ein Handeln oder ein Unterlassen ohne Schädigungsabsicht. Eine Person verhält sich fahrlässig, wenn Sie einen Schaden aufgrund der Außerachtlassung der erforderlichen Sorgfalt verursacht, obwohl sie nach ihren persönlichen Fähigkeiten und Kenntnissen in der Lage gewesen wäre, den Schadenseintritt vorherzusehen und zu vermeiden. Dies gilt auch dann, wenn der Schaden aufgrund eines Unterlassens (also eines Nichthandelns) eintrat und der Person eine Handlungspflicht zur Schadensabwendung zugesprochen werden kann.</p>
    </div>
  `,
  ...
  debriefingAB: `
    <div class="instructions">
      ...
      <p>Das prospektive Gedächtnis beschreibt die Fähigkeit, geplante Handlungen zum richtigen Zeitpunkt auszuführen. Es funktioniert im Alltag häufig zuverlässig, insbesondere bei wichtigen Aufgaben, kann jedoch durch Stress, Ablenkung oder Zeitdruck beeinträchtigt werden. Individuell wird diese Fähigkeit sowohl überschätzt als auch unterschätzt: Manche Personen verlassen sich zu stark auf ihr Gedächtnis und nutzen keine unterstützenden Strategien, während andere ihre Erinnerungsleistung geringer einschätzen, als sie tatsächlich ist.</p>
      ...
      <p>Ihre Teilnahme war freiwillig, alle Angaben werden anonym ausgewertet. Wenn Sie Fragen zur Studie haben, können Sie sich jederzeit an die Studienleitung wenden.</p>
  ...
  debriefingC: `
    <div class="instructions">
      <p>Vielen Dank für Ihre Teilnahme an dieser Online-Studie.</p>
      <p>In dieser Untersuchung ging es darum zu erfassen, wie Menschen Handlungen und deren Folgen beurteilen, insbesondere im Hinblick auf Fahrlässigkeit. Ihre Antworten tragen dazu bei, besser zu verstehen, welche Rolle Wissen und Informationsverfügbarkeit bei der Bewertung menschlichen Handelns spielen.</p>
      <p>Ich möchte Sie freundlich darum bitten, sich <strong>nicht mit anderen Teilnehmenden über die Inhalte, Fragestellungen oder Abläufe der Studie auszutauschen</strong>. Ein solcher Austausch könnte die Ergebnisse verfälschen und die wissenschaftliche Aussagekraft der Untersuchung beeinträchtigen.</p>
      <p>Vielen Dank für Ihr Verständnis und Ihre Unterstützung der Forschung.</p>
